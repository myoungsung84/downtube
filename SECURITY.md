...
Security guidance for Downtube is documented here in English first.  
The Korean section below is provided as a reference translation.
...
If GitHub private vulnerability reporting is available for this repository, use it. Otherwise, contact the maintainer through an available GitHub contact channel.
...
Share enough detail to reproduce and validate the issue, but avoid posting sensitive information publicly.
...
이 저장소에서 GitHub 비공개 취약점 제보 기능을 사용할 수 있다면 그 경로를 사용해 주세요. 사용할 수 없다면 GitHub에서 제공되는 maintainer 연락 수단을 통해 제보해 주세요.

제보 시 아래 내용을 함께 포함해 주세요.
